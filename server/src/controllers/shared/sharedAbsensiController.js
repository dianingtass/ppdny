...
const getKamarDetail = async (req, res) => {
  try {
    const { id } = req.params;
...
const getAbsensiDetail = async (req,res)=>{
  try{
...
const getLatestAbsensi = async (req, res) => {
  try {
    const { id } = req.params;
...
const getSantriByKamar = async (req, res) => {
...
const getItemKebersihan = async (req, res) => {
  try {
