      ...
      <div className="bg-[url('/header.png')] bg-cover bg-center text-white p-6 pb-40 shadow-lg md:pb-24">
        <div className="max-w-6xl mx-auto flex items-center gap-4">
          ...
          <div className="min-w-0">
              ...
              <p className="text-green-100 text-sm truncate">Monitoring kehadiran dan partisipasi anak</p>
          </div>
        </div>
      </div>
                ...
                <div key={item.id} className="bg-white rounded-2xl p-5 shadow-sm border border-gray-100 hover:shadow-md transition flex flex-col md:flex-row gap-6 items-start md:items-center">
                    ...
                    <div className="flex-1 w-full">
                        ...
                        <button 
                            ...
                            className="w-full md:w-auto bg-green-50 text-green-600 hover:bg-green-100 px-4 py-2 rounded-lg text-sm font-bold transition flex items-center justify-center"
                        >
                            Lihat Rincian
                        </button>
                    </div>
